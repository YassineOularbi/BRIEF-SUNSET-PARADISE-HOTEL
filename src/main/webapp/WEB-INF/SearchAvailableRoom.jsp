                ...
                <form id="formCheck" method="post" action="searchavailableroom" class="form-checking row" >
                    ...
                    <div class="col-md-2 mb-2">
                        ...
                        <select class="form-control mt-1" id="roomType" name="inputType">
                            <option value="Room" ${inputType eq '' ? 'selected' : ''}>SELECT</option>
        ...
        <c:forEach var="room" items="${arrayRoom}">
                ...
                <div class="card room-card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="reservation?Id=${room.getRoomId()}&checkIn=${checkIn}&checkOut=${checkOut}" class="btn btn-warning">Book</a>
                    </div>
